    ...
    core_1.NgModule({
        imports: [
            ...
            router_1.RouterModule.forChild([
                { path: 'products', component: product_list_component_1.ProductListComponent, canActivate: [auth_guard_service_1.AuthGuard] },
                {
                    path: 'products/:id',
        ...
        providers: [
            product_service_1.ProductService, product_resolver_service_1.ProductResolver, product_guard_service_1.ProductEditGuard
        ]
    })
], ProductModule);
